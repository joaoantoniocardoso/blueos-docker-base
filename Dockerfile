...
ARG LIBCAMERA_VERSION=v0.7.1+rpt20260609
ARG LIBCAMERA_GIT_URL=https://github.com/raspberrypi/libcamera.git
...
path-include=/usr/share/fonts/truetype/
path-include=/usr/share/fonts/truetype/dejavu/
path-include=/usr/share/fonts/truetype/dejavu/**
